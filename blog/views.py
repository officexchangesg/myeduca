...
class PostListView(ListView):
    ...
    """
    # Instead of defining a queryset attribute, we could have specified model = Post and
    # Django would have built the generic Post.objects.all() QuerySet for us.
...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'officexchangesg@gmail.com',
                      [cd['to']])
            sent = True
    else:
        form = EmailPostForm()
